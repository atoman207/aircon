        ...
        <div className="header-inner">
          ...
          <div className="actions-wrapper">
            <div className="phone-container">
              ...
              <a href="tel:0120-996-277" className="phone-number">
        ...
        <div className="hero-container">
          ...
          <div className="hero-content">
            ...
            <div className="cta-buttons">
              <a href="tel:0120-996-277" className="btn-large btn-white-phone">
                <Image src="/images/Group 1314.png" alt="" className="btn-icon-img" width={50} height={50} /> 0120-996-277
              </a>
        ...
        <div className="container">
          <div className="flex-wrapper">
            ...
            <div className="image-box">
              <Image src="/images/clean.png" alt="Professional Worker" className="process-img" width={500} height={600} />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="contact-left">
            <div className="info-card phone">
              ...
              <div className="card-text">
                ...
                <p className="phone-num">0120-996-277</p>
